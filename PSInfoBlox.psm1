...
Try {
    #Import the config
    $Script:IBConfig = $null
    $Script:IBConfig = Get-InfoBloxConfig -Source Infoblox.xml -ErrorAction Stop | Select -Property Uri, IBVersion, IBSession
	Write-Verbose $Script:IBConfig
}
Catch {   
